...
<body>
    ...
    @csrf
        ...
        <input type="text" id="patient_id" name="patient_id" placeholder="Enter patient's id number.."> <br><br>
        ...
        <input type="text" id="visit_id" name="visit_id" placeholder="Enter patient's visit.."> <br>
         ...
         <table id="myTable">
                ...
                <tr>
                    <td>MID%</td>
                    <td> <input type="text" name="MIDp"></td>
                    <td>%</td>
                    <td>1.0-15.0</td>
		        </tr>
                <tr>
                    <td>GRAN%</td>
                    <td> <input type="text" name="GRANp"></td>
                    <td>%</td>
                    <td>50.0-70.0</td>
		        </tr>
                <tr>
                    <td>LYM#</td>
                    <td> <input type="text" name="LYMn"></td>
                    <td>x10^9/L</td>
                    <td>0.6-4.1</td>
		        </tr>
                <tr>
                    <td>MID#</td>
                    <td> <input type="text" name="MIDn"></td>
                    <td>x10^9/L</td>
                    <td>0.1-1.8</td>
		        </tr>
                <tr>
                    <td>GRAN#</td>
                    <td> <input type="text" name="GRANn"></td>
                    <td>x10^9/L</td>
                    <td>2.0-7.8</td>
		        </tr>
                <tr>
                ...
                <tr>
                    <td>HGB</td>
                    <td> <input type="text" name="HGB"></td>
                    <td>g/dL</td>
                    <td>11.5-17.5</td>
		        </tr>
                <tr>
                ...
                <tr>
                    <td>RDW_CV</td>
                    <td> <input type="text" name="RDW_CV"></td>
                    <td>%</td>
                    <td>11.0-16.0</td>
		        </tr>
                <tr>
                    <td>RDW_SD</td>
                    <td> <input type="text" name="RDW_SD"></td>
                    <td>fL</td>
                    <td>35.0-56.0</td>
		        </tr>
                <tr>
                ...
                <tr>
                    <td>PDW</td>
                    <td> <input type="text" name="PDW"></td>
                    <td>fL</td>
                    <td>9.0-17.0</td>
		        </tr>
                <tr>
                ...
                <tr>
                    <td>P_LCR</td>
                    <td> <input type="text" name="P_LCR"></td>
                    <td>%</td>
                    <td>11.0-45.0</td>
		        </tr>
                <tr>
                    <td>P_LCC</td>
                    <td> <input type="text" name="P_LCC"></td>
                    <td>x10^9/L</td>
                    <td>11.0-135.0</td>
		        </tr>
                <tr>
